...
## Project Structure
    ...
    ├── testapiautocatalog_111480  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111480`
...
2. Clone this repo and `cd testapiautocatalog_111480`
